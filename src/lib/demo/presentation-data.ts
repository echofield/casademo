...
const DEMO_MISSED_OPPORTUNITIES: MissedOpportunity[] = [
  ...
  {
    id: 'mo-009',
    created_at: '2025-04-15T11:05:00Z',
    date: '2025-04-15',
    seller_id: 'seller-elliott',
    seller_name: 'Elliott Devauchelle',
    client_id: 'client-thomas-bernier',
    result: 'Missed',
    missed_type: 'No follow-up',
    description: 'Strong spring travel-tailoring review on video. Client said he would revisit after Lisbon. No follow-up appointment was set during the call.',
    cause: 'Seller did not propose a concrete follow-up window before closing the call. Momentum from the review was lost.',
    impact: 'Travel window closed without a proposal. Estimated loss: 2,400 EUR on the missed blazer and knit layer.',
    recommended_action: 'Rebook a short review for mid-May. Send a tight two-piece proposal tied to his return week.',
  },
  {
    id: 'mo-010',
    created_at: '2025-04-17T14:40:00Z',
    date: '2025-04-17',
    seller_id: 'seller-maxime',
    seller_name: 'Maxime Berthier',
    client_id: 'client-maya-lambert',
    result: 'Missed',
    missed_type: 'No proactive outreach',
    description: 'Client walked into the boutique during lunch and browsed knitwear. No one approached her or framed the new drop. She left without engaging.',
    cause: 'Seller did not step forward when she entered. No greeting, no quiet reframe around the new arrivals.',
    impact: 'No sale. Estimated loss: 600 EUR on a knit piece she has previously flagged as a priority.',
    recommended_action: 'Set a floor-protocol reminder: greet known clients within 90 seconds, lead with one relevant piece.',
  },
  {
    id: 'mo-011',
    created_at: '2025-04-19T16:10:00Z',
    date: '2025-04-19',
    seller_id: 'seller-helen',
    seller_name: 'Helen Chiu',
    client_id: 'client-clara-montrose',
    result: 'Missed',
    missed_type: 'Unoffered upsell',
    description: 'Client mentioned a partner gift moment while reviewing accessories. Seller did not introduce a small leather piece as a higher-tier alternative.',
    cause: 'Hesitated to trade up on a declared gifting moment. Kept the conversation at the first accessory shown.',
    impact: 'No expansion. Estimated loss: 1,800 EUR between the leather piece and a complementary accessory.',
    recommended_action: 'On declared gifting moments, always present one tier up as an option, even briefly. Let the client decline, not the seller pre-empt.',
  },
  {
    id: 'mo-012',
    created_at: '2025-04-21T10:55:00Z',
    date: '2025-04-21',
    seller_id: 'seller-yassmine',
    seller_name: 'Yassmine Moutaouakil',
    client_id: 'client-arthur-marchand',
    result: 'Missed',
    missed_type: 'Window closed',
    description: 'Discussed a dinner-jacket capsule over phone. Client asked to think. No recontact was scheduled. Two weeks later the client booked elsewhere.',
    cause: 'No recontact date was placed in the calendar. The "think about it" window was left open-ended.',
    impact: 'Capsule lost to a competitor. Estimated loss: 1,500 EUR.',
    recommended_action: 'Never end a "think about it" call without a fixed recontact date. Send a one-line written recap the same day.',
  },
]

        ...
        <div className="min-w-0">
          ...
          {client.phone && (
            <div className="mt-1 flex items-center gap-2">
              ...
              <span
                role="link"
                onClick={(e) => { e.preventDefault(); e.stopPropagation(); window.open(`https://wa.me/${client.phone!.replace(/\D/g, '')}`, '_blank') }}
                className="text-primary/60 hover:text-primary cursor-pointer transition-colors"
                title="WhatsApp"
              >
